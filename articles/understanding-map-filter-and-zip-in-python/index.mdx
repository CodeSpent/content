...
Lets take an example that applies the function `square()` to a list of integers. The objective here is to get a list of squared numbers from our orig/inal `numbers` list.
